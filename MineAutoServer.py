...
try:
    ...
    # Testing, are we in pyinstall or not
    ...
    def checkDescription():
        ...
        # (idk is easter egg)
        if (motd_value == "" or motd_value == "idk" or motd_value == "Idk" or motd_value == "IDk" or motd_value == "IDK" or motd_value == "idK" or motd_value == "iDK" or motd_value == "iDk"):
    ...
    def checkGamemode():
        ...
        if (gamemode == "" or gamemode.lower() == "survival"):
    ...
    def checkDifficulty():
        ...
        if (difficulty.lower() == "peaceful"):
            ...
            with open('server.properties', 'w') as write:
                write.writelines(properties_value)
        elif (difficulty == "" or difficulty.lower() == "easy"):
